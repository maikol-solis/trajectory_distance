 ...
 */
  ...
  __Pyx_WriteUnraisable("traj_dist.c_segment_distance._ordered_mixed_distance", __pyx_clineno, __pyx_lineno, __pyx_filename, 0);
  __pyx_r = 0;
  __pyx_L0:;
